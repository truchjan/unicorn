...
values ('Google', 'www.google.com', null, 'This is google.', 1, 1, 0, 1);

insert into link(name, url, image, description, available_firefox, available_chrome, active, new_tab)
values ('Facebook', 'www.facebook.com', null, 'This is facebook.', 1, 1, 1, 0);

insert into link(name, url, image, description, available_firefox, available_chrome, active, new_tab)
values ('Youtube', 'www.youtube.com', null, 'Great platform to watch videos.', 1, 1, 1, 0);

insert into link(name, url, image, description, available_firefox, available_chrome, active, new_tab)
values ('Unicorn', 'www.unicorn.com', null, 'Very nice company.', 1, 1, 1, 1);

insert into link(name, url, image, description, available_firefox, available_chrome, active, new_tab)
values ('Chrome gang', 'www.chromegang.com', null, 'We love chrome.', 0, 1, 1, 1);

insert into link(name, url, image, description, available_firefox, available_chrome, active, new_tab)
values ('Firefox crew', 'www.firefoxcrew.com', null, 'Firefox is the best.', 1, 0, 0, 1);